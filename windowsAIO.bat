...
powershell -Command "Invoke-WebRequest https://github.com/Wizkiller96/WizBotInstallerWin/raw/1.4/WizBotRun.bat -OutFile '%FILENAME%'"
ECHO.
...
powershell -Command "Invoke-WebRequest https://github.com/Wizkiller96/WizBotInstallerWin/raw/1.4/WizBotAutoRun.bat -OutFile '%FILENAME%'"
ECHO.
...
powershell -Command "Invoke-WebRequest https://github.com/Wizkiller96/WizBotInstallerWin/raw/1.4/WizBotCredentials.bat -OutFile '%FILENAME%'"
